...
import com.swp493.indievibe.Features.Authentication.Model.RegisterRequest;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> register(@Valid @RequestBody RegisterRequest user, BindingResult result) {
        ...
        IndieUser indieUser = new IndieUser();

        indieUser.setEmail(user.getEmail());
        indieUser.setPassword(user.getPassword());
        indieUser.setDisplayName(user.getDisplayName());

        userService.register(indieUser);
